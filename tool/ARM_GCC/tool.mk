...
CFLAG+= $(TOOL_CFLAG) -D__NEWLIB__ -D_REENT_SMALL -D__DYNAMIC_REENT__ $(FLOAT_OPTION) 
CPFLAG+= $(TOOL_CPFLAG) -D__NEWLIB__ -D_REENT_SMALL -D__DYNAMIC_REENT__ $(FLOAT_OPTION)
